...
void displayCarProperty(const Car &car, void (Car::*propertyPtr)()) { (car.*propertyPtr)(); }
...
int main()
{
	...
	{
	case 1:
		displayCarProperty(myCar, displayModelPtr);
		break;
	case 2:
		displayCarProperty(myCar, displayYearPtr);
		break;
	case 3:
		displayCarProperty(myCar, displayColorPtr);
		break;
	default:
		std::cout << "Invalid choice\n";
	}
	// Implementation without the pointer to member function
	switch (choice)
	{
	case 1:
		myCar.displayModel();
